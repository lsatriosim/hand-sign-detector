...
library(imager)
setwd('D:/OneDrive - Institut Teknologi Sepuluh Nopember/ITS/Analitika Bisnis/Final 
Project/dataset_baru_clean')
images <- list.files('D:/OneDrive - Institut Teknologi Sepuluh Nopember/ITS/Analitika 
Bisnis/Final Project/dataset_baru_clean', pattern='jpg')
for(x in images){
 setwd('D:/OneDrive - Institut Teknologi Sepuluh Nopember/ITS/Analitika Bisnis/Final 
Project/dataset_baru_clean')
 img <- load.image(x)
